...
import { VmAutoScalingDemo } from "@/components/templates/compute-scaling/vm-auto-scaling/vm-auto-scaling-demo";
import { getCategory, getTemplate } from "@/lib/catalog/catalog";

export default function VmAutoScalingPage() {
  const template = getTemplate("vm-auto-scaling")!;
