...
import { ContainerLifecycleDemo } from "@/components/templates/compute-scaling/container-lifecycle/container-lifecycle-demo";
import { SiteHeader } from "@/components/site-header";
import { getCategory, getTemplate } from "@/lib/catalog/catalog";

export default function ContainerLifecyclePage() {
  const template = getTemplate("container-lifecycle")!;
