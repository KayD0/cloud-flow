...
import { KubernetesPodSchedulingDemo } from "@/components/templates/compute-scaling/kubernetes-pod-scheduling/kubernetes-pod-scheduling-demo";
import { SiteHeader } from "@/components/site-header";
import { getCategory, getTemplate } from "@/lib/catalog/catalog";

export default function KubernetesPodSchedulingPage() {
  const template = getTemplate("kubernetes-pod-scheduling")!;
