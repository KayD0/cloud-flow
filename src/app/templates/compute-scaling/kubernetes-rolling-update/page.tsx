...
import { KubernetesRollingUpdateDemo } from "@/components/templates/compute-scaling/kubernetes-rolling-update/kubernetes-rolling-update-demo";
import { getCategory, getTemplate } from "@/lib/catalog/catalog";

export default function KubernetesRollingUpdatePage() {
  const template = getTemplate("kubernetes-rolling-update")!;
