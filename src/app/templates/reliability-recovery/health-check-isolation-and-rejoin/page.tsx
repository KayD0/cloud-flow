...
import { HealthCheckIsolationAndRejoinDemo } from "@/components/templates/reliability-recovery/health-check-isolation-and-rejoin/health-check-isolation-and-rejoin-demo";
import { SiteHeader } from "@/components/site-header";
import { getCategory, getTemplate } from "@/lib/catalog/catalog";

export default function HealthCheckIsolationAndRejoinPage() {
  const template = getTemplate("health-check-isolation-and-rejoin")!;
  ...
  return (
    <main>
      ...
      <div className="page-shell detail-shell">
        ...
        <HealthCheckIsolationAndRejoinDemo />
      </div>
    </main>
  );
}
