...
import { CircuitBreakerDemo } from "@/components/templates/reliability-recovery/circuit-breaker/circuit-breaker-demo";
import { getCategory, getTemplate } from "@/lib/catalog/catalog";

export default function CircuitBreakerPage() {
  const template = getTemplate("circuit-breaker")!;
