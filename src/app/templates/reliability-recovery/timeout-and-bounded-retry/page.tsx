...
import { TimeoutAndBoundedRetryDemo } from "@/components/templates/reliability-recovery/timeout-and-bounded-retry/timeout-and-bounded-retry-demo";
import { getCategory, getTemplate } from "@/lib/catalog/catalog";

export default function TimeoutAndBoundedRetryPage() {
  const template = getTemplate("timeout-and-bounded-retry")!;
