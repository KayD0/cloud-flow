...
import { DatabaseReplicaPromotionDemo } from "@/components/templates/reliability-recovery/database-replica-promotion/database-replica-promotion-demo";
import { getCategory, getTemplate } from "@/lib/catalog/catalog";

export default function DatabaseReplicaPromotionPage() {
  const template = getTemplate("database-replica-promotion")!;
