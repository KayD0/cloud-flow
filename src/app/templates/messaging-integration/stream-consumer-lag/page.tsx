...
import { StreamConsumerLagDemo } from "@/components/templates/messaging-integration/stream-consumer-lag/stream-consumer-lag-demo";
import { SiteHeader } from "@/components/site-header";
import { getCategory, getTemplate } from "@/lib/catalog/catalog";

export default function StreamConsumerLagPage() {
  const template = getTemplate("stream-consumer-lag")!;
