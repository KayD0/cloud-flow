...
import { PubSubFanOutDemo } from "@/components/templates/messaging-integration/pub-sub-fan-out/pub-sub-fan-out-demo";
import { SiteHeader } from "@/components/site-header";
import { getCategory, getTemplate } from "@/lib/catalog/catalog";

export default function PubSubFanOutPage() {
  const template = getTemplate("pub-sub-fan-out")!;
