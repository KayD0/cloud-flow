...
import { RetryAndDeadLetterQueueDemo } from "@/components/templates/messaging-integration/retry-and-dead-letter-queue/retry-and-dead-letter-queue-demo";
import { getCategory, getTemplate } from "@/lib/catalog/catalog";

export default function RetryAndDeadLetterQueuePage() {
  const template = getTemplate("retry-and-dead-letter-queue")!;
