...
import { VpcVnetPeeringDemo } from "@/components/templates/network-connectivity/vpc-vnet-peering/vpc-vnet-peering-demo";
import { getCategory, getTemplate } from "@/lib/catalog/catalog";

export default function VpcVnetPeeringPage() {
  const template = getTemplate("vpc-vnet-peering")!;
