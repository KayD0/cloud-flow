...
import { PublicPrivateSubnetConnectivityDemo } from "@/components/templates/network-connectivity/public-private-subnet-connectivity/public-private-subnet-connectivity-demo";
import { SiteHeader } from "@/components/site-header";
import { getCategory, getTemplate } from "@/lib/catalog/catalog";

export default function PublicPrivateSubnetConnectivityPage() {
  const template = getTemplate("public-private-subnet-connectivity")!;
  ...
  return (
    <main>
      ...
      <div className="page-shell detail-shell">
        ...
        <PublicPrivateSubnetConnectivityDemo />
      </div>
    </main>
  );
}
