...
import { HostPathBasedRoutingDemo } from "@/components/templates/traffic-routing/host-path-based-routing/host-path-based-routing-demo";
import { SiteHeader } from "@/components/site-header";
import { getCategory, getTemplate } from "@/lib/catalog/catalog";

export default function HostPathBasedRoutingPage() {
  const template = getTemplate("host-path-based-routing")!;
    ...
    <main>
      ...
      <div className="page-shell detail-shell">
        ...
        <header className="category-hero template-detail-hero">
          <p className="hero-kicker"><span /> INTERACTIVE MINI GAME</p>
          <h1>{template.name}</h1>
