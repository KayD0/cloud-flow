...
import { CacheHitMissDemo } from "@/components/templates/data-storage/cache-hit-miss/cache-hit-miss-demo";
import { getCategory, getTemplate } from "@/lib/catalog/catalog";

export default function CacheHitMissPage() {
  const template = getTemplate("cache-hit-miss")!;
