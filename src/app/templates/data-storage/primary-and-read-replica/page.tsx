...
import { PrimaryAndReadReplicaDemo } from "@/components/templates/data-storage/primary-and-read-replica/primary-and-read-replica-demo";
import { SiteHeader } from "@/components/site-header";
import { getCategory, getTemplate } from "@/lib/catalog/catalog";

export default function PrimaryAndReadReplicaPage() {
  const template = getTemplate("primary-and-read-replica")!;
